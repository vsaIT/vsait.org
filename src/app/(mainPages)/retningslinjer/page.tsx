    ...
    <>
      ...
      <div className='z-10 mb-12 flex max-w-screen-xl flex-col'>
        ...
        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          ...
          <p>
            Det offisielle navnet på denne organisasjonen er Vietnamese Student
            Association in Trondheim, herunder VSAiT.
          </p>
        </div>

        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          <h2 className='mb-3 text-2xl font-bold'>§ 2: LOGO</h2>
        ...
        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          <h2 className='mb-3 text-2xl font-bold'>§ 3: FORMÅL</h2>
          <p className='mb-2'>
          ...
          <ul className='list-disc'>
            ...
            <li className='ml-7'>
              Fremme og bevare vietnamesisk kultur i det norske samfunn gjennom
              kulturelle arrangementer og prosjekter.
            </li>
          </ul>
        </div>

        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          <h2 className='mb-3 text-2xl font-bold'>§ 4: STRUKTUR</h2>
          ...
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            <h3 className='mb-3 text-xl font-bold'>DEL 1: MEDLEMSKAP</h3>
            <p className='mb-2'></p>
            <ul className='list-disc'>
              <li className='ml-7'>
                Hovedmedlemskap i VSAiT er åpent for alle studenter i Trondheim
                med interesse for eller tilknytning til Vietnam.
              </li>
              <li className='ml-7'>
          ...
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            ...
            <ul className='list-disc'>
              ...
              <li className='ml-7'>
                ...
                regi av VSAiT, så lenge de vilkår og tidsfrister for deltagelse
                satt i forbindelse med arrangementet er oppfylt.
              </li>
            </ul>
            <p className='mb-2'>
              <b>Støttemedlem:</b>
            ...
            <ul className='list-disc'>
              ...
              <li className='ml-7'>
                Kan delta på arrangement i regi av VSAiT, så lenge de vilkår og
                tidsfrister for deltagelse satt i forbindelse med arrangementet
                er oppfylt.
              </li>
            </ul>
            <p className='mb-2'>
          ...
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            ...
            <p className='mb-2'>
              ...
              hovedstyret, må ha studie som hovedbeskjeftigelse, og kvalifisere
              til hovedmedlemsskap under styringsperiode.
            </p>
            <p className='mb-2'>
              ...
              ordinære styremøter og øvrige styremedlemmer kalles inn til møter
              ved behov.
            </p>
            <div>
              ...
              <ol className='mb-2 list-decimal'>
                <li className='ml-7'>Overordnet ansvar for organisasjonen.</li>
              ...
              <ol className='mb-2 list-decimal'>
                <li className='ml-7'>Ha oversikt over foreningens økonomi.</li>
                <li className='ml-7'>
          ...
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            ...
            <p className='mb-2'>
              ...
              kan det ekskluderes ved ⅔ flertall vedtak av Styret. Medlemmer som
              har gjort seg skyldig i mindre forgåelse mot VSAiT regler,
              retningslinjer eller kollegiale bestemmelser kan, etter beslutning
              av styret, ilegges en mulkt.
            </p>
          </div>
        </div>

        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          <h2 className='mb-3 text-2xl font-bold'>§ 5: VALG/AVSTEMNING</h2>
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            <h3 className='mb-3 text-xl font-bold'>DEL 1: KVALIFISERING</h3>
            <ul className='mb-2 list-disc'>
              <li className='ml-7'>
                Alle kandidater som stiller til valg som styremedlem må være
                student i Trondheim og hovedmedlem av VSAiT. Dersom det ikke kan
                opprettes et nytt hovedstyre så åpnes det for et hovedstyre med
                støttemedlemmer der flertallet må være studenter. Da utvides
                ovennevnte kriterie til: Alle kandidater må være student i
                Trondheim eller ha vært vært student i Trondheim i løpet av de
                siste tre årene, i tillegg til å være hovedmedlem eller
                støttemedlem av VSAiT. Ytterligere må styreleder være
                hovedmedlem.
              </li>
              <li className='ml-7'>
                Kandidatene skal holde en kort presentasjon om seg selv, og hva
                de kan tilby VSAiT.
              </li>
              <li className='ml-7'>
                Styret har ansvar for å utlyse verv og stillingsbeskrivelse før
                valg.
              </li>
              <li className='ml-7'>
                Stiller man til valg for verv i hovedstyret skal vedkommende gi
                beskjed til styret/valgkomité på forhånd.
              </li>
            </ul>
          </div>
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            <h3 className='mb-3 text-xl font-bold'>DEL 2: AVSTEMNING</h3>
            <ul className='mb-2 list-disc'>
              <li className='ml-7'>
                Alle med hovedmedlemskap har stemmerett. Forhåndsavstemning med
                fullmakt tillates. Valg skal foregå anonymt dersom dette
                forslaget fremmes.
              </li>
              <li className='ml-7'>
          ...
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            ...
            <p className='mb-2'>
              Vervperiode er ett skoleår og valg av nytt styre skal finne sted i
              løpet av 1. Kvartal i året. Leder av VSAiT kan kun sitte
        ...
        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          <h2 className='mb-3 text-2xl font-bold'>§ 6: KONTINUITET</h2>
          <p className='mb-2'>
            ...
            løsøre overføres til det nye styret. De enkelte styremedlemmene har
            ansvar for å sette sin arvtaker inn i sine oppgaver.
          </p>
        </div>
        ...
        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          ...
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            <h3 className='mb-3 text-xl font-bold'>DEL 1: OPPSIGELSE</h3>
            <p className='mb-2'>
              Under spesielle forhold kan et styremedlem gå av. Det fratredende
              styremedlemmet må begrunne årsaken til oppsigelse til resten av
              styret. Beskjed skal bli gitt snarest mulig, minst 3 uker før
              fratredelse. Ved ekstraordinære omstendigheter kan det gjøres
              unntak dersom hovedstyret godkjenner dette.
            </p>
          </div>
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            <h3 className='mb-3 text-xl font-bold'>DEL 2: MISTILLITSFORSLAG</h3>
            <ul className='mb-2 list-disc'>
              <li className='ml-7'>
                ...
                retningslinjene eller fører VSAiT i vanry. Styremedlemmet kan da
                bli fratatt sitt verv med øyeblikkelig virkning.
              </li>
              <li className='ml-7'>
              ...
              <li className='ml-7'>
                Den/de som rammes av forslag om mistillit, har rett til å uttale
                seg for generalforsamling før vedtaket fattes.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          <h2 className='mb-3 text-2xl font-bold'>§ 8 GENERALFORSAMLING</h2>
          <p className='mb-2'>
            Generalforsamlingen er VSAiTs høyeste organ, og skal avholdes årlig,
            tidlig i vårsemesteret, hvor tidspunkt og sted bestemmes av styret.
            Ekstraordinær generalforsamling avholdes dersom enten:
          </p>
          <ol className='mb-2 list-decimal'>
            <li className='ml-7'>
          ...
          <p className='mb-2'>
            ...
            stemmerett, unntatt endring av retningslinjer eller logo, som krever
            kvalifisert 2/3 flertall blant fremmøtte med stemmerett. Alle
            hovedmedlemmer kan stille til alle verv. Man kan stille sitt
        ...
        <div className='mb-4 flex w-full flex-col justify-center rounded-2xl bg-white p-8 text-left shadow-lg'>
          ...
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            <h3 className='mb-3 text-xl font-bold'>DEL 1: STYREMØTER</h3>
            <ul className='mb-2 list-disc'>
              <li className='ml-7'>
                Det er styrets oppgave å arrangere møter og bestemme antall
                møter. Leder er ordstyrer ved de forskjellige møter dersom ingen
                andre er satt til dette. Styremøte bør avholdes minst en gang i
                måneden.
              </li>
              <li className='ml-7'>
                Styremedlemmene møtes for å diskutere saker og setter opp agenda
                for eventuelle åpne styremøter.
              </li>
              <li className='ml-7'>
              ...
              <li className='ml-7'>
                Alle medlemmer kan delta på åpne styremøter. De har da forslags
                og tale-, men ikke stemmerett.
              </li>
              <li className='ml-7'>
          ...
          <div className='flex w-full flex-col justify-center rounded-2xl bg-white p-4 text-left'>
            <h3 className='mb-3 text-xl font-bold'>DEL 2: ARRANGEMENTER</h3>
