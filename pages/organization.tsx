      ...
      <main className="flex w-full flex-1 flex-col items-center text-center">
        ...
        <div className="flex flex-col z-10 max-w-screen-xl mb-12">
          ...
          <div className="flex flex-col justify-center w-full p-8 mb-4 text-left bg-white shadow-lg rounded-2xl">
            <div className="mb-6">
              <h2 className="text-xl font-bold italic text-gray">
                Hvem er vi?
              </h2>
              <p>
                VSAiT er en frivillig og nonprofitt organisasjon, der hensikten
                er å skape et bånd i det vietnamesiske studentmiljøet i
                Trondheim. Organisasjonen er hovedsakelig rettet mot studenter
                ved NTNU og andre utdanningsinstitusjoner i Trondheim. Vi sørger
                for en god integrering av norsk-vietnamesiske studenter i et
                norsk miljø, samtidig som den vietnamesiske kulturen blir bevart
                og ivaretatt med den unge generasjonen.
              </p>
            </div>
            <div className="mb-6">
              <h2 className="text-xl font-bold italic text-gray">
              ...
              <p>
                VSAiT ble opprettet i 1990, og var en voksende organisasjon
                inntil 2009. I 2009 hadde VSAiT problemer med å finne nye
                styremedlemmer som kunne overta driften av organisasjonen, og
                det endte med at organisasjonen ble lagt på is. To år senere i
                2011, samlet en gruppe med interesse for å gjenopprette VSAiT
                seg, og organisasjonen kom til liv igjen. VSAiT var en veldig
                liten organisasjon i begynnelsen av gjenopprettelsen, men siden
                da har VSAiT opplevd stor vekst.
              </p>
            </div>
            <div className="mb-6">
            ...
            <div className="flex flex-col">
              <div className="flex justify-between px-24 py-12 my-2">
                ...
                <div className="flex flex-col w-full text-left">
                  ...
                  <p className="w-8/12">
                    Årets første arrangement. Vi inviterer gamle og nye
                    studenter på grilling. Det blir lek og morro!
                  </p>
                </div>
              </div>
